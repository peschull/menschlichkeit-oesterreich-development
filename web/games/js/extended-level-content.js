    ...
    initializeFollowUps() {
        return {
            ...
            "empathetic_solution": {
                ...
                dialogue: "Hey, danke nochmal für das Gespräch damals. Ich dachte, du solltest wissen - ich habe Kopfhörer gekauft für abends.",
                effect: "Die empathische Herangehensweise hat eine dauerhafte positive Beziehung geschaffen.",
            ...
            "community_building": {
                ...
                dialogue: "Einladung zum 'Kultur-Café': Jede Familie stellt ihre Traditionen vor. Mit Snacks aus aller Welt!",
            ...
            "conflict_escalation": {
                ...
                dialogue: "Familie Hassan: 'Wir fühlen uns hier nicht willkommen. Wir überlegen umzuziehen.'",
            ...
            "community_network": {
                ...
                dialogue: "15 Nachbarn helfen sich gegenseitig. Von Kinderbetreuung bis Einkaufen - alles organisiert.",
            ...
            "democratic_organizing": {
                ...
                dialogue: "50 Nachbarn haben mitgeholfen. Sogar Herr Grimmig war da und hat Schach gespielt!",
            ...
            "professional_mediation": {
                ...
                dialogue: "Frau König und Herr Pfeifer haben einen Parkplatz-Tauschplan entwickelt. Sie reden wieder miteinander!",
            ...
            "taking_sides": {
                ...
                dialogue: "Jetzt gibt es zwei Lager im Haus. Die Hälfte spricht nicht mehr mit der anderen Hälfte.",
            ...
            characters: {
                "frau_weber": {
                    ...
                    dialogues: {
                        ...
                        help_accepted: "Das ist so lieb von Ihnen. Ich weiß gar nicht, wie ich das zurückgeben soll...",
                ...
                "familie_hassan": {
                    ...
                    dialogues: {
                        cultural_pride: "Diese Teppiche sind von meiner Großmutter. Sie bedeuten uns sehr viel.",
                        ...
                        invitation: "Möchten Sie mal auf einen Tee vorbeikommen? Layla macht die besten Baklava!"
                    }
                },
                ...
                "familie_schmidt": {
                    ...
                    dialogues: {
                        concern: "Verstehen Sie, Lea ist noch so klein. Sie hat wirklich Angst vor großen Hunden.",
                        compromise: "Wenn wir eine Lösung finden, die für alle funktioniert, sind wir dabei.",
                        relief: "So ist es perfekt! Lea kann sicher spielen und die Hunde haben auch ihren Raum.",
