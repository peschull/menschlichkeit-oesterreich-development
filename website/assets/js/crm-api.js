  ...
  async createContact(contactData) {
    try {
      ...
      if (response.ok && data && data.success) {
        ...
        const msg =
          (data && (data.detail || data.message)) || 'Kontakt konnte nicht erstellt werden';
        return { success: false, error: msg };
      }
    } catch (error) {
  ...
  async updateContact(contactId, contactData) {
    try {
      ...
      if (response.ok) {
        ...
        return {
          success: false,
          error: error.detail || 'Kontakt konnte nicht aktualisiert werden',
        };
      }
    } catch (error) {
  ...
  async createMembership(membershipData) {
    try {
      ...
      if (response.ok && data && data.success) {
        ...
        const msg =
          (data && (data.detail || data.message)) || 'Mitgliedschaft konnte nicht erstellt werden';
        return { success: false, error: msg };
      }
    } catch (error) {
  ...
  async updateMembership(membershipId, membershipData) {
    try {
      ...
      if (response.ok) {
        ...
        return {
          success: false,
          error: error.detail || 'Mitgliedschaft konnte nicht aktualisiert werden',
        };
      }
    } catch (error) {
  ...
  async updateUserProfile(profileData) {
    try {
      ...
      if (response.ok && json && json.success) {
        ...
        const msg =
          (json && (json.detail || json.message)) || 'Profil konnte nicht aktualisiert werden';
        return { success: false, error: msg };
      }
    } catch (error) {
  ...
  async createSepaMandate(mandateData) {
    try {
      ...
      if (response.ok) {
        ...
        return {
          success: false,
          error: error.detail || 'SEPA-Mandat konnte nicht erstellt werden',
        };
      }
    } catch (error) {
