...
async function handleContactFormSubmission(e) {
  ...
  try {
    ...
    // Success feedback
    showNotification(
      'Vielen Dank für Ihre Nachricht! Wir melden uns binnen 24-48 Stunden bei Ihnen.',
      'success'
    );
    ...
    showNotification(
      'Entschuldigung, es gab ein Problem beim Senden Ihrer Nachricht. Bitte versuchen Sie es später erneut.',
      'error'
    );
